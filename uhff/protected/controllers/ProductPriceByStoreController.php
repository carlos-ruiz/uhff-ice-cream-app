...
class ProductPriceByStoreController extends Controller
{
	/**
	...
	{
		$model=new ProductPriceByStore;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ProductPriceByStore']))
		{
			$model->attributes=$_POST['ProductPriceByStore'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('ProductPriceByStore');
	 ...
	 * @return ProductPriceByStore the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ProductPriceByStore::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ProductPriceByStore $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='product-price-by-store-form')
		{
