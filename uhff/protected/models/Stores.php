...
class Stores extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'inventories' => array(self::HAS_MANY, 'Inventory', 'stores_id'),
			'productPriceByStores' => array(self::HAS_MANY, 'ProductPriceByStore', 'stores_id'),
			'users' => array(self::HAS_MANY, 'Users', 'stores_id'),
		);
	}
